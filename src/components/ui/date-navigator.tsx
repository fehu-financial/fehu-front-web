...
import { endOfMonth, format, isAfter, isBefore, isSameMonth, startOfMonth } from "date-fns";
...
const DateNavigator: React.FC<DateNavigatorProps> = ({ onDateSelect, initialMonth = new Date(), minDate, maxDate }) => {
	...
	const handleDateRangeChange = (range: DateRange | undefined) => {
		...
		const isExactMonth = isSameMonth(from, to) && fromIsStartOfMonth && toIsEndOfMonth;
			...
			<div className="flex-1 flex flex-col items-center">
				<Popover>
					<PopoverTrigger asChild>
						<Button variant="ghost" className={cn("pl-3 text-left font-normal")}>
