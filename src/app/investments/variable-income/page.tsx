...
import { DollarSignIcon, Table, TrendingDown, TrendingUp, TrendingUpDownIcon } from "lucide-react";
...
export default function VariableIncome() {
	...
	const totalCurrentValue = useMemo(
		() => assets.reduce((sum, asset) => sum + asset.quantity * asset.currentPrice, 0),
		[assets],
	);
	...
	const assetTypes = useMemo(() => {
		return assets.reduce(
			(acc, asset) => {
				...
				acc[assetType] = (acc[assetType] || 0) + asset.quantity * asset.currentPrice;
				return acc;
			},
