...
export default function InvestmentDashboard() {
	return (
		<div className="min-h-full overflow-auto scrollbar-hide">
			<div className="p-6">
				...
				<div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4 w-full">
					...
					<div className="col-span-3 flex space-x-4">
						<LinkCard
							...
							subtitle="Ações, BDRs, ETFs, Fundos, etc."
							href="variable-income"
						/>
						<LinkCard
							title="Renda Fixa"
							subtitle="CDBs, LCIs, LCAs e Tesouro Direto, etc."
							href="fixed-income"
						/>
					</div>
				</div>
